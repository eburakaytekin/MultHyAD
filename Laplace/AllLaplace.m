function [AUCMeanResult,AUCModeResult,elapsedTimeResult,FARMeanResult,FARModeResult,dtmapMeanArray,dtmapModeArray]=AllLaplace(DAT,FiltOn,PCAOn)
...
if PCAOn==1
[index]=PCAIndexCalcLaplace(diffim,map,FiltOn);   
...
tic
[aucMean,aucMode,FARMean,FARMode,dtmapMean,dtmapMode]=VBMLaplaceG(data,map,FiltOn,DAT);
elapsedTime = toc;
