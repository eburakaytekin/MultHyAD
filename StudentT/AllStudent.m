function [AUCMeanResult,AUCModeResult,elapsedTimeResult,FARMeanResult,FARModeResult,dtmapMeanArray,dtmapModeArray]=AllStudent(DAT,FiltOn,PCAOn)
...
if PCAOn==1
[index]=PCAIndexCalcStudent(diffim,map,FiltOn);   
...
tic
[aucMean,aucMode,FARMean,FARMode,dtmapMean,dtmapMode]=VBMstudentTG(data,map,FiltOn,DAT);
elapsedTime = toc;
