function [AUCMeanResult,AUCModeResult,elapsedTimeResult,FARMeanResult,FARModeResult,dtmapMeanArray,dtmapModeArray]=AllCauchy(DAT,FiltOn,PCAOn)
...
if PCAOn==1
[index]=PCAIndexCalcCauchy(diffim,map,FiltOn);   
...
tic
[aucMean,aucMode,FARMean,FARMode,dtmapMean,dtmapMode]=VBMCauchyG(data,map,FiltOn,DAT);
elapsedTime = toc;
